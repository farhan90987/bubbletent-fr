...
<div id="listing-store" class="listing-section">
    <div class="listeo-store-browse-more">
        <h3 class="listing-desc-headline margin-top-60 margin-bottom-30"><?php esc_html_e('Gutscheine', 'listeo_core'); ?>
    ...
    <div class="simple-slick-carousel  listeo-products-slider dots-nav">
        ...
        ?>
                <div class="fw-carousel-item listing-vendor-prod">
                    ...
                    <div <?php post_class('', $product->get_id()); ?>>
                        <div class="mediaholder">
                            ...
                            $label     = apply_filters('add_to_cart_text', esc_html__('In den Warenkorb', 'listeo'));
                            ?>
                            <a href="<?php echo esc_url($link); ?>" class="button cust-add-to-cart"><i class="fa fa-shopping-cart"></i> <?php echo esc_html($label); ?></a>
                        </div>
                        <section>
