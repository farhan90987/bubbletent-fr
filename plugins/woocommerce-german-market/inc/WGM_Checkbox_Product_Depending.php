...
class WGM_Checkbox_Product_Depending {
	...
	* @return Array
	*/
	public function checkbox_logging( $checkboxes_texts, $pre_symbol, $posted_data, $order, $api_checkout_data = array() ) {
		...
		for ( $i = 1; $i <= $nr_of_checkboxes; $i++ ) {
			...
			if ( isset( $data[ 'german-market-product-depending-checkbox-' . $i ] ) ) {
