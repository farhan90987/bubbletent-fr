...
function wcvat_show_admin_notice( $message ) {
	...
	switch ( $message ) {
		...
		case 'kleinunternehmerregelung':
			echo '<div class="error"><p>' . sprintf( __( 'Small-business regulation is active! To get <strong>WooCommerce EU VAT Number Check</strong> work, you need to disnable the <a href="%s">Small-business regulation</a> first.', 'woocommerce-german-market' ), admin_url( 'admin.php?page=german-market&tab=general&sub_tab=small-trading-exemption' ) ) . '</p></div>';
			break;
		default:
			break;
	}
