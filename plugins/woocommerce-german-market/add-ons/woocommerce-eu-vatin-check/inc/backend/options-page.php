...
function wcvat_woocommerce_de_ui_render_options() {
	...
	$settings = array(
		...
		array(
			...
			'type'  => 'title',
			'desc'  => '<strong><em>' . __( 'If you use the block-based checkout, you can add the "EU VAT Number Check" block to the inner block "Checkout Fields" to display field on you block-based checkout page.', 'woocommerce-german-market' ) . '</em></strong><br><br>' . __( 'By default, the field for the vat number is displayed on the checkout page if the customer\'s country is an EU country that does not correspond to your shop base country. Otherwise, the field is not displayed.', 'woocommerce-german-market' )
					. '<br><br>' . sprintf( 
