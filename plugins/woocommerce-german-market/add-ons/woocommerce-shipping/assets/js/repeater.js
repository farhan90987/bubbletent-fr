...
(function($) {
	/**
	 * Check for init package boxes repeater.
	 */
	function package_box_repeater() {
		if ( $( '.german-market .boxes-repeater' ).length ) {
			$( '.german-market .boxes-repeater' ).repeater({
				initEmpty: false,
				defaultValues: {
					'name': ''
				},
