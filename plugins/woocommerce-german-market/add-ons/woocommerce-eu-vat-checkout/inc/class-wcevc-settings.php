...
class WCEVC_Settings {
	...
	*/
	public static function import_eu_tax_rates() {
		...
		$desciption = sprintf( 
			__( 'Using these options you can import the tax rates of the member states of the EU into your WooCommerce tax classes. These tax rates were taken from the <a href="%s" target="_blank">Taxes in Europe Database</a> (as of January 2025). No liability is assumed for the accuracy, timeliness and completeness of the tax rates. Please double check the tax rates after importing them yourself.', 'woocommerce-german-market' ),
