	...
	*/
	class WCREAPDF_Helper {	
		...
		*/
		 ...
		 * @return void
		 */
		public static function utf8_decode( $utf8_string, $used_for_file_name = false ) {
			$return_string = mb_convert_encoding( $utf8_string, 'ISO-8859-1', 'UTF-8' );

			if ( ! $used_for_file_name ) {
				$return_string = apply_filters( 'wccreapdf_helper_utf8_decode', $return_string, $utf8_string );
			}
		 ...
		 * @return void
		 */
		public static function utf8_encode( $iso_string, $used_for_file_name = false ) {
			$return_string = mb_convert_encoding( $iso_string, 'UTF-8', 'ISO-8859-1' );

			if ( ! $used_for_file_name ) {
				$return_string = apply_filters( 'wccreapdf_helper_utf8_encode', $return_string, $iso_string );
			}
