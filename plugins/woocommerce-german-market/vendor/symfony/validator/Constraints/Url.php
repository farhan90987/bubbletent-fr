...
class Url extends Constraint
{
    ...
    public function __construct(
        ...
        if (null === ($options['requireTld'] ?? $requireTld)) {
            marketpress_german_market_trigger_deprecation('symfony/validator', '7.1', 'Not passing a value for the "requireTld" option to the Url constraint is deprecated. Its default value will change to "true".');
        }
