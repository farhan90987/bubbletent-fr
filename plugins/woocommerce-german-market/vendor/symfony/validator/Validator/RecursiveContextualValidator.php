...
use MarketPress\German_Market\Symfony\Component\Validator\Constraints\Composite;
use MarketPress\German_Market\Symfony\Component\Validator\Constraints\Existence;
...
use MarketPress\German_Market\Symfony\Component\Validator\Context\ExecutionContext;
...
use MarketPress\German_Market\Symfony\Component\Validator\Exception\RuntimeException;
use MarketPress\German_Market\Symfony\Component\Validator\Exception\UnexpectedValueException;
use MarketPress\German_Market\Symfony\Component\Validator\Exception\UnsupportedMetadataException;
use MarketPress\German_Market\Symfony\Component\Validator\Exception\ValidatorException;
use MarketPress\German_Market\Symfony\Component\Validator\Mapping\CascadingStrategy;
use MarketPress\German_Market\Symfony\Component\Validator\Mapping\ClassMetadataInterface;
use MarketPress\German_Market\Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface;
use MarketPress\German_Market\Symfony\Component\Validator\Mapping\GenericMetadata;
use MarketPress\German_Market\Symfony\Component\Validator\Mapping\GetterMetadata;
use MarketPress\German_Market\Symfony\Component\Validator\Mapping\MetadataInterface;
use MarketPress\German_Market\Symfony\Component\Validator\Mapping\PropertyMetadataInterface;
use MarketPress\German_Market\Symfony\Component\Validator\Mapping\TraversalStrategy;
use MarketPress\German_Market\Symfony\Component\Validator\ObjectInitializerInterface;
use MarketPress\German_Market\Symfony\Component\Validator\Util\PropertyPath;
...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
    ...
    public function validateProperty(object $object, string $propertyName, string|GroupSequence|array|null $groups = null): static
    {
        ...
        if (!$classMetadata instanceof ClassMetadataInterface) {
            throw new ValidatorException(\sprintf('The metadata factory should return instances of "\MarketPress\German_Market\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
        }
    ...
    private function validateObject(object $object, string $propertyPath, array $groups, int $traversalStrategy, ExecutionContextInterface $context): void
    {
        try {
            ...
            if (!$classMetadata instanceof ClassMetadataInterface) {
                throw new UnsupportedMetadataException(\sprintf('The metadata factory should return instances of "MarketPress\German_Market\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
            }
            ...
            if (Constraint::DEFAULT_GROUP === $group) {
                if ($metadata->hasGroupSequence()) {
                    ...
                    if (null !== $provider = $metadata->getGroupProvider()) {
                        ...
                        // object
                        /* @var \MarketPress\German_Market\Symfony\Component\Validator\GroupSequenceProviderInterface $object */
        ...
        foreach ($metadata->getConstrainedProperties() as $propertyName) {
            ...
            foreach ($metadata->getPropertyMetadata($propertyName) as $propertyMetadata) {
                if (!$propertyMetadata instanceof PropertyMetadataInterface) {
                    throw new UnsupportedMetadataException(\sprintf('The property metadata instances should implement "MarketPress\German_Market\Symfony\Component\Validator\Mapping\PropertyMetadataInterface", got: "%s".', get_debug_type($propertyMetadata)));
                }
