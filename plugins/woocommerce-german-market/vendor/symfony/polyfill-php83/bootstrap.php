...
use MarketPress\German_Market\Symfony\Polyfill\Php83 as p;
...
if (!function_exists('marketpress_german_market_ldap_connect_wallet') && function_exists('ldap_connect')) {
    function marketpress_german_market_ldap_connect_wallet(?string $uri, string $wallet, string $password, int $auth_mode = \GSLC_SSL_NO_AUTH) { return ldap_connect($uri, $wallet, $password, $auth_mode); }
}
