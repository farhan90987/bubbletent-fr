...
class LogisticsServiceChargeType
{
    ...
    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $appliedAmount
     */
    private $appliedAmount = null;

    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\ram\TradeTaxType[] $appliedTradeTax
     */
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $appliedAmount
     * @return self
     */
    public function setAppliedAmount(\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $appliedAmount)
    {
     ...
     *
     * @return self
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\ram\TradeTaxType $appliedTradeTax
     */
    public function addToAppliedTradeTax(\MarketPress\German_Market\horstoeko\zugferd\entities\extended\ram\TradeTaxType $appliedTradeTax)
    {
