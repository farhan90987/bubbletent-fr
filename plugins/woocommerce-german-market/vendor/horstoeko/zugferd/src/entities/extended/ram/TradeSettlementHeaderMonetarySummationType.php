...
class TradeSettlementHeaderMonetarySummationType
{
    ...
    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $taxBasisTotalAmount
     */
    ...
    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $roundingAmount
     */
    ...
    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $totalPrepaidAmount
     */
    private $totalPrepaidAmount = null;

    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $duePayableAmount
     */
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $taxBasisTotalAmount
     * @return self
     */
    public function setTaxBasisTotalAmount(\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $taxBasisTotalAmount)
    {
     ...
     */
    public function addToTaxTotalAmount(\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $taxTotalAmount)
    {
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $roundingAmount
     * @return self
     */
    public function setRoundingAmount(?\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $roundingAmount = null)
    {
     ...
     * @return self
     */
    public function setGrandTotalAmount(\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $grandTotalAmount)
    {
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $totalPrepaidAmount
     * @return self
     */
    public function setTotalPrepaidAmount(?\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $totalPrepaidAmount = null)
    {
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $duePayableAmount
     * @return self
     */
    public function setDuePayableAmount(\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $duePayableAmount)
    {
