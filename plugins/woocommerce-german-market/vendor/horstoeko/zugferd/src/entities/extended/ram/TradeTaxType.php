...
class TradeTaxType
{
    ...
    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $calculatedAmount
     */
    ...
    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $lineTotalBasisAmount
     */
    private $lineTotalBasisAmount = null;

    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $allowanceChargeBasisAmount
     */
    ...
    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\CodeType $exemptionReasonCode
     */
    private $exemptionReasonCode = null;

    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\DateType $taxPointDate
     */
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $calculatedAmount
     * @return self
     */
    public function setCalculatedAmount(?\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $calculatedAmount = null)
    {
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $lineTotalBasisAmount
     * @return self
     */
    public function setLineTotalBasisAmount(?\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $lineTotalBasisAmount = null)
    {
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $allowanceChargeBasisAmount
     * @return self
     */
    public function setAllowanceChargeBasisAmount(?\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\AmountType $allowanceChargeBasisAmount = null)
    {
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\CodeType $exemptionReasonCode
     * @return self
     */
    public function setExemptionReasonCode(?\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\CodeType $exemptionReasonCode = null)
    {
     ...
     *
     * @return \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\DateType
     */
     ...
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\DateType $taxPointDate
     * @return self
     */
    public function setTaxPointDate(?\MarketPress\German_Market\horstoeko\zugferd\entities\extended\udt\DateType $taxPointDate = null)
    {
