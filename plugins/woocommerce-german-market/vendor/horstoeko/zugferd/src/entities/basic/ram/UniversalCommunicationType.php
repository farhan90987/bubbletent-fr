...
class UniversalCommunicationType
{
    ...
    /**
     * @var \MarketPress\German_Market\horstoeko\zugferd\entities\basic\udt\IDType $uRIID
     */
    private $uRIID = null;
     ...
     * Sets a new uRIID
     *
     * @param  \MarketPress\German_Market\horstoeko\zugferd\entities\basic\udt\IDType $uRIID
     * @return self
     */
    public function setURIID(\MarketPress\German_Market\horstoeko\zugferd\entities\basic\udt\IDType $uRIID)
    {
        $this->uRIID = $uRIID;
        return $this;
    }
