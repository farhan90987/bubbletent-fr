...
use MarketPress\German_Market\horstoeko\zugferd\exception\ZugferdUnknownDateFormatException;
use MarketPress\German_Market\horstoeko\zugferd\exception\ZugferdUnsupportedMimetype;
...
class ZugferdObjectHelper
{
    ...
    {
        $className = 'MarketPress\German_Market\horstoeko\zugferd\entities\\' . $this->profiledef["name"] . '\\' . $classname;
