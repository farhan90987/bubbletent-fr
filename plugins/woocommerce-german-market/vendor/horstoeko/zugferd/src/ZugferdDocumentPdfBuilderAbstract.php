...
use DOMXpath;
use Throwable;
use MarketPress\German_Market\horstoeko\mimedb\MimeDb;
use MarketPress\German_Market\horstoeko\stringmanagement\FileUtils;
use MarketPress\German_Market\horstoeko\stringmanagement\StringUtils;
...
use MarketPress\German_Market\horstoeko\zugferd\exception\ZugferdUnknownMimetype;
use MarketPress\German_Market\horstoeko\zugferd\exception\ZugferdInvalidArgumentException;
use MarketPress\German_Market\horstoeko\zugferd\ZugferdPackageVersion;
use MarketPress\German_Market\horstoeko\zugferd\ZugferdPdfWriter;
use MarketPress\German_Market\horstoeko\zugferd\ZugferdSettings;
use MarketPress\German_Market\setasign\Fpdi\PdfParser\StreamReader as PdfStreamReader;
...
abstract class ZugferdDocumentPdfBuilderAbstract
{
    ...
    {
        $toolName = sprintf('Factur-X PHP library v%s by HorstOeko', '1.0.113');
