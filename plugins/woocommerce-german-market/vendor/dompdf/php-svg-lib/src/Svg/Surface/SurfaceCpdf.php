...
namespace MarketPress\German_Market\Svg\Surface;

use MarketPress\German_Market\Svg\Document;
...
class SurfaceCpdf implements SurfaceInterface
{
    ...
    /** @var \MarketPress\German_Market\Svg\Surface\CPdf */
    private $canvas;
    ...
    public function __construct(Document $doc, $canvas = null)
    {
        ...
        if (!$canvas) {
            $canvas = new \MarketPress\German_Market\Svg\Surface\CPdf(array(0, 0, $w, $h));
