...
class Frame
{
     ...
     */
    public function set_decorator(\MarketPress\German_Market\Dompdf\FrameDecorator\AbstractFrameDecorator $decorator)
    {
    ...
    public function __toString()
    {
        ...
        if ($this->_decorator instanceof \MarketPress\German_Market\Dompdf\FrameDecorator\Block) {
            $str .= "Lines:<pre>";
            foreach ($this->_decorator->get_line_boxes() as $line) {
                foreach ($line->get_frames() as $frame) {
                    if ($frame instanceof \MarketPress\German_Market\Dompdf\FrameDecorator\Text) {
                        $str .= "\ntext: ";
