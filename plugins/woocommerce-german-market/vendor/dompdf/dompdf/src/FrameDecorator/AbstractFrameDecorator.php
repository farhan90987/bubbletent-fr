...
use MarketPress\German_Market\Dompdf\Frame\FrameListIterator;
use MarketPress\German_Market\Dompdf\Frame\FrameTreeIterator;
use MarketPress\German_Market\Dompdf\FrameReflower\AbstractFrameReflower;
use MarketPress\German_Market\Dompdf\Css\Style;
use MarketPress\German_Market\Dompdf\Positioner\AbstractPositioner;
/**
...
abstract class AbstractFrameDecorator extends Frame
{
     ...
     */
    public function lookup_counter_frame(string $id = self::DEFAULT_COUNTER, bool $auto_reset = false): ?AbstractFrameDecorator
    {
        $f = $this->get_parent();
        while ($f) {
