 ...
 */
namespace MarketPress\German_Market\Dompdf\Frame;
...
use MarketPress\German_Market\Dompdf\FrameDecorator\Page as PageFrameDecorator;
use MarketPress\German_Market\Dompdf\FrameReflower\Page as PageFrameReflower;
...
class Factory
{
    ...
    public static function decorate_frame(Frame $frame, Dompdf $dompdf, ?Frame $root = null): ?AbstractFrameDecorator
    {
        ...
        $decorator = "MarketPress\\German_Market\\Dompdf\\FrameDecorator\\{$decorator}";
        $reflower = "MarketPress\\German_Market\\Dompdf\\FrameReflower\\{$reflower}";
        ...
        if ($display === "list-item") {
            ...
            if ($parent_node && $parent_node instanceof \DOMElement) {
                ...
                } else if (!$parent_node->hasAttribute("dompdf-counter")) {
    ...
    protected static function getPositionerInstance(string $type): AbstractPositioner
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\MarketPress\German_Market\Dompdf\Positioner\\' . $type;
