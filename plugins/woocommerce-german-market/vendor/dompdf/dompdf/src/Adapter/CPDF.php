...
namespace MarketPress\German_Market\Dompdf\Adapter;

use MarketPress\German_Market\Dompdf\Canvas;
use MarketPress\German_Market\Dompdf\Dompdf;
use MarketPress\German_Market\Dompdf\Exception;
use MarketPress\German_Market\Dompdf\FontMetrics;
use MarketPress\German_Market\Dompdf\Helpers;
use MarketPress\German_Market\Dompdf\Image\Cache;
use MarketPress\German_Market\FontLib\Exception\FontNotFoundException;
/**
...
class CPDF implements Canvas
{
     ...
     *
     * @var \MarketPress\German_Market\Dompdf\Cpdf
     */
    protected $_pdf;
    /**
     * PDF width, in points
    ...
    public function __construct($paper = "letter", string $orientation = "portrait", ?Dompdf $dompdf = null)
    {
        ...
        $this->_pdf = new \MarketPress\German_Market\Dompdf\Cpdf($size, true, $this->_dompdf->getOptions()->getFontCache(), $this->_dompdf->getOptions()->getTempDir());
     ...
     *
     * @return \MarketPress\German_Market\Dompdf\Cpdf
     */
    ...
    public function select($x, $y, $w, $h, $font, $size, $color = [0, 0, 0], $opts = [])
    {
        ...
        $ft = \MarketPress\German_Market\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE;
        $ff = \MarketPress\German_Market\Dompdf\Cpdf::ACROFORM_FIELD_CHOICE_COMBO;
    ...
    public function textarea($x, $y, $w, $h, $font, $size, $color = [0, 0, 0])
    {
        ...
        $ft = \MarketPress\German_Market\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
        $ff = \MarketPress\German_Market\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_MULTILINE;
    ...
    public function input($x, $y, $w, $h, $type, $font, $size, $color = [0, 0, 0])
    {
        ...
        switch ($type) {
            ...
            case 'password':
                $ft = \MarketPress\German_Market\Dompdf\Cpdf::ACROFORM_FIELD_TEXT;
                $ff = \MarketPress\German_Market\Dompdf\Cpdf::ACROFORM_FIELD_TEXT_PASSWORD;
                break;
            case 'submit':
                $ft = \MarketPress\German_Market\Dompdf\Cpdf::ACROFORM_FIELD_BUTTON;
                break;
        }
        $pdf->addFormField($ft, rand(), $x, $this->y($y) - $h, $x + $w, $this->y($y), $ff, $size, $color);
    }
