...
use MarketPress\German_Market\FontLib\AdobeFontMetrics;
use MarketPress\German_Market\FontLib\Font;
use MarketPress\German_Market\FontLib\BinaryStream;
use MarketPress\German_Market\FontLib\Table\Table;
use MarketPress\German_Market\FontLib\Table\DirectoryEntry;
use MarketPress\German_Market\FontLib\Table\Type\glyf;
use MarketPress\German_Market\FontLib\Table\Type\name;
use MarketPress\German_Market\FontLib\Table\Type\nameRecord;
...
class File extends BinaryStream {
  ...
  function parseTableEntries() {
    ...
    $class = "MarketPress\\German_Market\\FontLib\\$type\\TableDirectoryEntry";
  ...
  protected function readTable($tag) {
    ...
    if (!self::$raw) {
      ...
      $class = "MarketPress\\German_Market\\FontLib\\Table\\Type\\$name_canon";
      ...
      $class = "MarketPress\\German_Market\\FontLib\\Table\\Table";
    }
