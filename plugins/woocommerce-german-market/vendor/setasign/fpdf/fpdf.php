<?php
/*******************************************************************************
* MarketPress_German_Market_FPDF                                                                         *
*                                                                              *
* Version: 1.86                                                                *
* Date:    2023-06-25                                                          *
...
class MarketPress_German_Market_FPDF
{
const VERSION = '1.86';
...
function __construct($orientation='P', $unit='mm', $size='A4')
{
	...
	// Metadata
	$this->metadata = array('Producer'=>'MarketPress_German_Market_FPDF '.self::VERSION);
...
{
	// Fatal error
	throw new Exception('MarketPress_German_Market_FPDF error: '.$msg);
}
