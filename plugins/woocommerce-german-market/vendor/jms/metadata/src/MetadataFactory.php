...
use MarketPress\German_Market\Metadata\Driver\AdvancedDriverInterface;
...
class MetadataFactory implements AdvancedMetadataFactoryInterface
{
    ...
    public function __construct(DriverInterface $driver, ?string $hierarchyMetadataClass = 'MarketPress\German_Market\Metadata\ClassHierarchyMetadata', bool $debug = false)
    {
        $this->driver = $driver;
