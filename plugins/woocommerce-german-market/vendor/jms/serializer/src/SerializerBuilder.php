...
use MarketPress\German_Market\JMS\Serializer\Builder\DefaultDriverFactory;
use MarketPress\German_Market\JMS\Serializer\Builder\DocBlockDriverFactory;
use MarketPress\German_Market\JMS\Serializer\Builder\DriverFactoryInterface;
use MarketPress\German_Market\JMS\Serializer\Construction\ObjectConstructorInterface;
use MarketPress\German_Market\JMS\Serializer\Construction\UnserializeObjectConstructor;
use MarketPress\German_Market\JMS\Serializer\ContextFactory\CallableDeserializationContextFactory;
use MarketPress\German_Market\JMS\Serializer\ContextFactory\CallableSerializationContextFactory;
use MarketPress\German_Market\JMS\Serializer\ContextFactory\DeserializationContextFactoryInterface;
use MarketPress\German_Market\JMS\Serializer\ContextFactory\SerializationContextFactoryInterface;
...
use MarketPress\German_Market\JMS\Serializer\EventDispatcher\Subscriber\DoctrineProxySubscriber;
use MarketPress\German_Market\JMS\Serializer\EventDispatcher\Subscriber\EnumSubscriber;
...
use MarketPress\German_Market\JMS\Serializer\GraphNavigator\Factory\DeserializationGraphNavigatorFactory;
use MarketPress\German_Market\JMS\Serializer\GraphNavigator\Factory\GraphNavigatorFactoryInterface;
use MarketPress\German_Market\JMS\Serializer\GraphNavigator\Factory\SerializationGraphNavigatorFactory;
use MarketPress\German_Market\JMS\Serializer\Handler\ArrayCollectionHandler;
use MarketPress\German_Market\JMS\Serializer\Handler\DateHandler;
use MarketPress\German_Market\JMS\Serializer\Handler\EnumHandler;
use MarketPress\German_Market\JMS\Serializer\Handler\HandlerRegistry;
use MarketPress\German_Market\JMS\Serializer\Handler\HandlerRegistryInterface;
use MarketPress\German_Market\JMS\Serializer\Handler\IteratorHandler;
use MarketPress\German_Market\JMS\Serializer\Handler\StdClassHandler;
use MarketPress\German_Market\JMS\Serializer\Handler\UnionHandler;
use MarketPress\German_Market\JMS\Serializer\Naming\CamelCaseNamingStrategy;
use MarketPress\German_Market\JMS\Serializer\Naming\PropertyNamingStrategyInterface;
use MarketPress\German_Market\JMS\Serializer\Naming\SerializedNameAnnotationStrategy;
...
use MarketPress\German_Market\JMS\Serializer\Visitor\Factory\DeserializationVisitorFactory;
use MarketPress\German_Market\JMS\Serializer\Visitor\Factory\JsonDeserializationVisitorFactory;
use MarketPress\German_Market\JMS\Serializer\Visitor\Factory\JsonSerializationVisitorFactory;
use MarketPress\German_Market\JMS\Serializer\Visitor\Factory\SerializationVisitorFactory;
use MarketPress\German_Market\JMS\Serializer\Visitor\Factory\XmlDeserializationVisitorFactory;
use MarketPress\German_Market\JMS\Serializer\Visitor\Factory\XmlSerializationVisitorFactory;
use MarketPress\German_Market\Metadata\Cache\CacheInterface;
use MarketPress\German_Market\Metadata\Cache\FileCache;
use MarketPress\German_Market\Metadata\MetadataFactory;
