...
abstract class QROutputAbstract implements QROutputInterface{
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Data\QRMatrix::getSize()
	 */
	...
	/**
	 * @var \MarketPress\German_Market\chillerlan\Settings\SettingsContainerInterface|\MarketPress\German_Market\chillerlan\QRCode\QROptions
	 */
	protected SettingsContainerInterface $options;

	/** @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$scale */
	protected int $scale;
	/** @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$connectPaths */
	protected bool $connectPaths;
	/** @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$excludeFromConnect */
	protected array $excludeFromConnect;
	/** @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$eol */
	protected string $eol;
	/** @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$drawLightModules */
	protected bool $drawLightModules;
	/** @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$drawCircularModules */
	protected bool $drawCircularModules;
	/** @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$keepAsSquare */
	protected array $keepAsSquare;
	/** @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$circleRadius */
	 ...
	 * @throws \MarketPress\German_Market\chillerlan\QRCode\Output\QRCodeOutputException if $moduleValues[$M_TYPE] doesn't exist
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\QROptions::$cachefile
	 *
