...
namespace MarketPress\German_Market\chillerlan\QRCode;

use MarketPress\German_Market\chillerlan\QRCode\Common\{
	EccLevel, ECICharset, GDLuminanceSource, IMagickLuminanceSource, LuminanceSourceInterface, MaskPattern, Mode, Version
};
use MarketPress\German_Market\chillerlan\QRCode\Data\{AlphaNum, Byte, ECI, Hanzi, Kanji, Number, QRData, QRDataModeInterface, QRMatrix};
use MarketPress\German_Market\chillerlan\QRCode\Decoder\{Decoder, DecoderResult};
use MarketPress\German_Market\chillerlan\QRCode\Output\{QRCodeOutputException, QROutputInterface};
use MarketPress\German_Market\chillerlan\Settings\SettingsContainerInterface;
...
class QRCode{
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\Version::AUTO
	 * @var int
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\MaskPattern::AUTO
	 * @var int
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\EccLevel::L
	 * @var int
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\EccLevel::M
	 * @var int
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\EccLevel::Q
	 * @var int
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\EccLevel::H
	 * @var int
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::MARKUP_HTML
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::MARKUP_SVG
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::GDIMAGE_PNG
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::GDIMAGE_JPG
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::GDIMAGE_GIF
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::STRING_JSON
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::STRING_TEXT
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::IMAGICK
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::FPDF
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::EPS
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::CUSTOM
	 * @var string
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::MODES
	 * @var string[]
	 */
	 ...
	 *
	 * @var \MarketPress\German_Market\chillerlan\QRCode\QROptions|\MarketPress\German_Market\chillerlan\Settings\SettingsContainerInterface
	 */
	 ...
	 *
	 * @var \MarketPress\German_Market\chillerlan\QRCode\Data\QRDataModeInterface[]
	 */
	...
	public function render(?string $data = null, ?string $file = null){
		...
		if($data !== null){
			/** @var \MarketPress\German_Market\chillerlan\QRCode\Data\QRDataModeInterface $dataInterface */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\QRCode::getQRMatrix()
	 * @codeCoverageIgnore
	 */
	 ...
	 *
	 * @throws \MarketPress\German_Market\chillerlan\QRCode\Output\QRCodeOutputException
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Data\Number::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Data\AlphaNum::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Data\Kanji::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Data\Byte::validateString()
	 * @codeCoverageIgnore
	 */
	 ...
	 *
	 * @throws \MarketPress\German_Market\chillerlan\QRCode\QRCodeException
	 */
