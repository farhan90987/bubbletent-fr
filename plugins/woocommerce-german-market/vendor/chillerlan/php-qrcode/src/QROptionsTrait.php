...
use MarketPress\German_Market\chillerlan\QRCode\Common\{EccLevel, MaskPattern, Version};
...
trait QROptionsTrait{
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\Version
	 */
	 ...
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\EccLevel
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Common\MaskPattern
	 */
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QREps
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QRFpdf
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QRGdImage
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QRImagick
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QRMarkupHTML
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QRMarkupSVG
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QRString
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputInterface::dump()
	 */
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\QRCode::render()
	 * @see \MarketPress\German_Market\chillerlan\QRCode\QRCode::renderMatrix()
	 */
	 ...
	 * (default: `true`)
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputAbstract::toBase64DataURI()
	 */
	 ...
	 * (default: `false`)
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Data\QRMatrix::invert()
	 */
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputAbstract::collectModules()
	 * @see \MarketPress\German_Market\chillerlan\QRCode\QROptionsTrait::$excludeFromConnect
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\QROptionsTrait::$connectPaths
	 */
	 ...
	 * - `QREps`: `[C, M, Y, K]` // 0-255
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QROutputAbstract::setModuleValues()
	 */
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\QRCode::addMatrixModifications()
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Data\QRMatrix::setLogoSpace()
	 */
	 ...
	 *
	 * @see \MarketPress\German_Market\chillerlan\QRCode\Output\QRGdImage::createImage()
	 * @see https://github.com/chillerlan/php-qrcode/issues/23
	 */
	 ...
	 * @see        \MarketPress\German_Market\chillerlan\QRCode\QROptions::$outputBase64
	 */
	 ...
	 * @see        \MarketPress\German_Market\chillerlan\QRCode\QROptions::$quality
	 */
	 ...
	 * @see        \MarketPress\German_Market\chillerlan\QRCode\QROptions::$transparencyColor
	 */
	 ...
	 * @see        \MarketPress\German_Market\chillerlan\QRCode\QROptions::$bgColor
	 */
