...
use MarketPress\German_Market\chillerlan\QRCode\Common\{BitBuffer, EccLevel, LuminanceSourceInterface, MaskPattern, Mode, Version};
use MarketPress\German_Market\chillerlan\QRCode\Data\{AlphaNum, Byte, ECI, Hanzi, Kanji, Number};
use MarketPress\German_Market\chillerlan\QRCode\Detector\Detector;
use Throwable;
...
final class Decoder{
	 ...
	 *
	 * @throws \Throwable|\MarketPress\German_Market\chillerlan\QRCode\Decoder\QRCodeDecoderException
	 */
	...
	/**
	 * @throws \MarketPress\German_Market\chillerlan\QRCode\Decoder\QRCodeDecoderException
	 */
