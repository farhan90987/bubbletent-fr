...
use MarketPress\German_Market\chillerlan\QRCode\QRCodeException;
...
final class GenericGFPoly{
	 ...
	 *
	 * @throws \MarketPress\German_Market\chillerlan\QRCode\QRCodeException if argument is null or empty, or if leading coefficient is 0 and this
	...
	/**
	 * @return \MarketPress\German_Market\chillerlan\QRCode\Common\GenericGFPoly[] [quotient, remainder]
