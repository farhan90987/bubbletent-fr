...
use MarketPress\German_Market\chillerlan\QRCode\Common\{BitBuffer, Mode};
use Throwable;
...
final class Hanzi extends QRDataModeAbstract{
	 ...
	 * @inheritDoc
	 *
	 * @throws \MarketPress\German_Market\chillerlan\QRCode\Data\QRCodeDataException on an illegal character occurence
	 */
