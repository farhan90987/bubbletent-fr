...
final class AlignmentPatternFinder{
	...
	/** @var \MarketPress\German_Market\chillerlan\QRCode\Detector\AlignmentPattern[] */
	private array $possibleCenters;

	/**
	 * Creates a finder that will look in a portion of the whole image.
	 *
	 * @param \MarketPress\German_Market\chillerlan\QRCode\Decoder\BitMatrix $matrix     image to search
	 ...
	 *
	 * @return \MarketPress\German_Market\chillerlan\QRCode\Detector\AlignmentPattern|null
	 */
	 ...
	 *
	 * @return \MarketPress\German_Market\chillerlan\QRCode\Detector\AlignmentPattern|null if we have found the same pattern twice, or null if not
	 */
