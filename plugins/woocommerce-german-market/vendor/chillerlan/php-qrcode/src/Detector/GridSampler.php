...
final class GridSampler{
	 ...
	 *
	 * @throws \MarketPress\German_Market\chillerlan\QRCode\Detector\QRCodeDetectorException if an endpoint is lies outside the image boundaries
	 */
	 ...
	 * image space.
	 *
	 * @return \MarketPress\German_Market\chillerlan\QRCode\Decoder\BitMatrix representing a grid of points sampled from the image within a region
	 *   defined by the "from" parameters
	 * @throws \MarketPress\German_Market\chillerlan\QRCode\Detector\QRCodeDetectorException if image can't be sampled, for example, if the transformation defined
