...
{
    /**
     * @var array<\MarketPress\German_Market\Smalot\PdfParser\Font>|null
     */
    protected $fonts;
    /**
    ...
    protected function setupFonts()
    {
        ...
        if (method_exists($resources, 'has') && $resources->has('Font')) {
            ...
            if ($resources->get('Font') instanceof \MarketPress\German_Market\Smalot\PdfParser\Element\ElementMissing) {
                return;
            }
