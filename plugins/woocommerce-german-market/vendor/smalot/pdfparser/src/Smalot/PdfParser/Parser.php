...
namespace MarketPress\German_Market\Smalot\PdfParser;

use MarketPress\German_Market\Smalot\PdfParser\Element\ElementArray;
use MarketPress\German_Market\Smalot\PdfParser\Element\ElementBoolean;
use MarketPress\German_Market\Smalot\PdfParser\Element\ElementDate;
use MarketPress\German_Market\Smalot\PdfParser\Element\ElementHexa;
use MarketPress\German_Market\Smalot\PdfParser\Element\ElementName;
use MarketPress\German_Market\Smalot\PdfParser\Element\ElementNull;
use MarketPress\German_Market\Smalot\PdfParser\Element\ElementNumeric;
use MarketPress\German_Market\Smalot\PdfParser\Element\ElementString;
use MarketPress\German_Market\Smalot\PdfParser\Element\ElementXRef;
use MarketPress\German_Market\Smalot\PdfParser\RawData\RawDataParser;
            ...
            switch ($part[0]) {
                ...
                case 'stream':
                    ...
                    if ($header->get('Type')->equals('ObjStm')) {
                        ...
                        return;
                    } elseif ($header->get('Type')->equals('MarketPress\German_Market\Metadata')) {
