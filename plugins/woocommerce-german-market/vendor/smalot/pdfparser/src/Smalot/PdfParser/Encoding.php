...
use MarketPress\German_Market\Smalot\PdfParser\Encoding\EncodingLocator;
use MarketPress\German_Market\Smalot\PdfParser\Encoding\PostScriptGlyphs;
use MarketPress\German_Market\Smalot\PdfParser\Exception\EncodingNotFoundException;
...
class Encoding extends PDFObject
{
    ...
    protected function getEncodingClass(): string
    {
        ...
        $className = '\\MarketPress\\German_Market\\Smalot\\PdfParser\\Encoding\\'.$baseEncoding;
