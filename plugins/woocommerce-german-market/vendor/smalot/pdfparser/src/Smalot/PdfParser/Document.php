...
use MarketPress\German_Market\Smalot\PdfParser\Encoding\PDFDocEncoding;
use MarketPress\German_Market\Smalot\PdfParser\Exception\MissingCatalogException;
