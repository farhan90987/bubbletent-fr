...
use MarketPress\German_Market\Smalot\PdfParser\Exception\InvalidDictionaryObjectException;
use MarketPress\German_Market\Smalot\PdfParser\XObject\Form;
use MarketPress\German_Market\Smalot\PdfParser\XObject\Image;
    ...
    public static function factory(
        ...
        switch ($header->get('Type')->getContent()) {
            ...
            case 'Font':
                ...
                $classname = '\MarketPress\German_Market\Smalot\PdfParser\Font\Font'.$subtype;
