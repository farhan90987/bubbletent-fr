...
👉 [**CHECK FREE DEMO - FORMS WITH CONDITIONAL LOGIC**](https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=view_demos#view-demo-forms)

https://youtu.be/0Fbueg7DSts

Upgrade to **[Conditional Fields Pro](https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=below_video)** for advanced features like conditional redirects, conditional emails, and conditional Mailchimp. Or supercharge your Elementor forms with **[Cool FormKit](https://coolformkit.com/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=below_video)** (aka coolformkit) — the all-in-one form builder addon for Elementor. With coolformkit, you can add powerful fields such as a **[range slider](https://coolformkit.com/features/range-slider-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=features&utm_content=below_video)**, **[signature field](https://coolformkit.com/features/signature-field-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=features&utm_content=below_video)**, **[Select2 field](https://coolformkit.com/features/select2-field-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=features&utm_content=below_video)**, and more to build smarter, feature-rich forms.
...
* **[Conditionally Redirect After Submission](https://docs.coolplugins.net/doc/conditional-redirect-elementor-form-on-submit/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=pro_features_redirect)**  
...
* **[Apply Condition on Submit Button](https://docs.coolplugins.net/doc/elementor-form-submit-button-conditions/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=pro_features_button)**  
...
* **[Send Email Conditionally](https://docs.coolplugins.net/doc/send-conditional-emails-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=pro_features_email)**  
...
* **[Apply Multiple Conditions (AND / OR Logic)](https://docs.coolplugins.net/doc/and-or-conditional-logic-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=pro_features_multiple)**  
...
* **[Condition Triggers / Compare Operators](https://docs.coolplugins.net/doc/elementor-form-conditional-logic-operators/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=pro_features_operators)**  
...
* **[Premium Support](https://coolplugins.net/support/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=support&utm_content=pro_features_support)**  
...
* **[Cool FormKit for Elementor](https://coolformkit.com/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=elementor_form_addons)**  
 An advanced form builder for Elementor Free users. It also extends Elementor Pro and Hello Plus form widgets with features like **[conditional logic](https://coolformkit.com/features/conditional-logic-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=features&utm_content=elementor_form_addons)**, **[country code](https://coolformkit.com/features/country-code-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=features&utm_content=elementor_form_addons)**, **[WhatsApp redirect](https://coolformkit.com/features/whatsapp-redirect-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=features&utm_content=elementor_form_addons)**, **[input masks](https://coolformkit.com/features/input-mask-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=features&utm_content=elementor_form_addons)**, and more. Upgrade your form-building experience with Cool FormKit.

* **[Country Code for Elementor Form Telephone Field](https://wordpress.org/plugins/country-code-field-for-elementor-form/)**  
 Adds a country code dropdown to phone fields, guiding your visitors to select their country code while entering their mobile number to ensure accurate and properly formatted data submissions.

* **[Form Input Masks for Elementor Forms](https://wordpress.org/plugins/form-masks-for-elementor/)**  
 Apply input masks to form fields so your users can enter correctly formatted data, such as phone numbers, dates, credit card numbers, and more.
...
* **[Timeline Widget for Elementor](https://cooltimeline.com/plugin/timeline-widget-pro/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=other_addons)**  
 Showcase your history, events, or milestones in a stylish vertical or horizontal timeline layout on Elementor pages.

* **[Events Widgets for Elementor](https://eventscalendaraddons.com/plugin/events-widgets-pro/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=other_addons)**  
 Adds **The Events Calendar** plugin widgets for Elementor, allowing you to display events in grid, list, or carousel layouts on your Elementor pages.

* **[AutoPoly – AI Translation for Polylang](https://coolplugins.net/product/autopoly-ai-translation-for-polylang/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=other_addons)**  
 An addon for the Polylang plugin that automatically translates Elementor pages using AI-powered translation services — making multilingual site creation fast and simple.

* **[Loop Grid Extender for Elementor Pro](https://wordpress.org/plugins/loop-grid-extender-for-elementor-pro/)**  
 Use ACF Repeater fields in Elementor Pro loop grids or add advanced taxonomy filters to your Elementor loop templates with this plugin.

* **[LocoAI – Auto Translate for Loco Translate](https://locoaddon.com/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=other_addons)**  
 Automatically translate any WordPress plugin or theme strings in one click — powered by AI.
...
*The intuitive setup means I can now implement conditional logic with ease, vastly improving our form functionality without compromising aesthetics. Highly recommended!* — [@sambadee](https://wordpress.org/support/topic/finally-easy-conditional-fields-yay/)

**Long Overdue ⭐⭐⭐⭐⭐**  
*This plugin is so long overdue. Over the years I’ve seen many others that are overcomplicated and difficult to use. This is lightweight, powerful, and easy for anyone to use. Thank you.* — [@maxbyer](https://wordpress.org/support/topic/long-overdue-2/)

**Great Support ⭐⭐⭐⭐⭐**  
*Simple and efficient! Support is ready to solve issues and committed to improving and implementing new features! Thank you for your help.* — [@xxkiefxx](https://wordpress.org/support/topic/great-support-5420/)

**At Last ⭐⭐⭐⭐⭐**  
*Finally, a free plugin that adds conditional logic to Elementor forms in a simple and intuitive way. It does what it says — and does it well. Thank you!* — [@mrprainx](https://wordpress.org/support/topic/at-last-43/)

**Great Plugin! ⭐⭐⭐⭐⭐**  
*I searched the whole internet for this. Most Elementor add-ons you have to pay for don’t have it, but Cool Plugins did it. It’s super easy and directly integrated into the Elementor interface and form. Thanks a lot! Great job, guys!* — [@huks](https://wordpress.org/support/topic/great-plugin-38541/)

---

[**Get Conditional Fields for Elementor Form [PREMIUM]**](https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=bottom_name)
...
Yes. With the Conditional Fields for Elementor Form plugin, you can [hide or show Elementor form fields](https://docs.coolplugins.net/doc/apply-conditional-logic-on-elementor-form-fields/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=faqs) based on user input values. For example, display an “Order ID” field only if the user selects “Order Status” in a dropdown.  
...
* **OR logic** triggers an action if any one condition is met (available in the [Pro version](https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=faqs)).

= Can I redirect an Elementor form to different URLs after submission? =
Yes. In the Pro version, you can set [conditional redirects for Elementor forms](https://docs.coolplugins.net/doc/conditional-redirect-elementor-form-on-submit/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=faqs).  
...
Example: If a user types restricted words into a textarea, you can [disable the submit button automatically](https://docs.coolplugins.net/doc/elementor-form-submit-button-conditions/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=faqs).  
...
Yes. With the Pro version, you can [send conditional emails from Elementor forms](https://docs.coolplugins.net/doc/send-conditional-emails-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=faqs) to different recipients or user types based on field values.
...
See the full list of [conditional operators for Elementor forms](https://docs.coolplugins.net/doc/elementor-form-conditional-logic-operators/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=faqs).
...
You can report security vulnerabilities through the [Patchstack Vulnerability Disclosure Program](https://patchstack.com/database/vdp/conditional-fields-for-elementor-form).
...
1. Go to **"wp-admin >> Plugins >> Add New"** in your WordPress dashboard, search for **"Conditional Fields for Elementor Form"**, and install and activate the plugin developed by [Cool Plugins](https://coolplugins.net/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=author&utm_content=installation).
...
3. Edit a page with Elementor and create a form. In the Elementor form widget, you’ll find a **Conditions tab** where you can add rules to hide, show, enable, or disable fields. For step-by-step instructions, check the [getting started guide](https://docs.coolplugins.net/doc/apply-conditional-logic-on-elementor-form-fields/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=installation).
...
#### Step 1:
First, install **Elementor Pro** (or Hello Plus for Elementor Free), then install **[Conditional Fields for Elementor Form](https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=installation)**.  
...
* Apply multiple conditions using the **AND operator** (all conditions must match).  
  – The Pro version also supports **OR operator** logic. Learn more in the [AND/OR conditions guide](https://docs.coolplugins.net/doc/and-or-conditional-logic-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=installation).
* Use comparison operators like **equals (==), not equals (!=), greater than (>), less than (<)**.  
  – The Pro version adds advanced operators: **>=, <=, contains, does not contain, starts with, ends with, empty, not empty**. See the full list of [supported operators](https://docs.coolplugins.net/doc/elementor-form-conditional-logic-operators/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=installation).
...
👉 For full documentation, visit the [Conditional Fields for Elementor Form Docs](https://docs.coolplugins.net/plugin/conditional-fields-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=installation).

[**Get the Pro version of Conditional Fields for Elementor Form**](https://coolplugins.net/product/conditional-fields-for-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=installation)
...
* More details: [check all conditional logic operators](https://docs.coolplugins.net/doc/elementor-form-conditional-logic-operators/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=changelog).
...
* [Check changelog of Pro version](https://docs.coolplugins.net/doc/changelog-conditional-fields-elementor-form/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=docs&utm_content=changelog)
* or Try **[Cool FormKit](https://coolformkit.com/?utm_source=cfef_plugin&utm_medium=readme&utm_campaign=get_pro&utm_content=changelog)**
