...
class Wt_Advanced_Order_Number_Review_Request
{
	/**
	* config options 
	*/
	private $plugin_title="Sequential Order Number for WooCommerce";
	private $review_url="https://wordpress.org/support/plugin/wt-woocommerce-sequential-order-numbers/reviews/#new-post";
	private $plugin_prefix="wt_advanced_order_number"; /* must be unique name */
	private $activation_hook="wt_advanced_order_number_activate"; /* hook for activation, to store activated date */
	private $deactivation_hook="wt_advanced_order_number_deactivate"; /* hook for deactivation, to delete activated date */
	private $days_to_show_banner=10; /* when did the banner to show */
	private $remind_days=15; /* remind interval in days */
	private $webtoffee_logo_url=WT_SEQUENCIAL_ORDNUMBER_URL.'assets/images/webtoffee-logo_small.png';
	...
	*/
	public function show_banner()
	{
		...
		<div class="<?php echo esc_attr($this->banner_css_class); ?> notice-info notice is-dismissible">
            ...
            <div class="wt-seq-review-footer" style="position: relative;">
                <span class="wt-seq-footer-icon" style="position: absolute;right: 0;bottom: 10px;"><img src="<?php echo esc_url($this->webtoffee_logo_url); ?>" style="max-width:100px;"></span>
            </div>
        </div>
		<?php
	}
...
new Wt_Advanced_Order_Number_Review_Request();