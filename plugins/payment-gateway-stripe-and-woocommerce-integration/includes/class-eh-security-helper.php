...
if(!class_exists('EH_Helper_Class'))
{
	...
	class EH_Helper_Class 
	{
		...
		*/
		...
		/**
		 * Function provide filter to alter the allowed page slugs for showing admin notices
		 * @return allowed page slugs
		 */ 
        public static function wt_stripe_allowed_screens(){
            return apply_filters( 'wt_stripe_allowed_page_slugs', array( 'eh-stripe-overview','wt_stripe_menu' ) );
		...
		/**
		 * Function checks the current screen included in allowed screens
