...
class Pinterest extends Settings implements Pixel {
	...
	public function __construct() {
        add_action( 'pys_admin_pixel_ids', array( $this, 'renderPixelIdField' ), 20 );
	}
	...
	public function renderPixelIdField() {
        ...
        <div class="d-flex pixel-wrap align-items-center justify-content-between">
            <div class="pixel-heading d-flex justify-content-start align-items-center">
                <img class="tag-logo" src="<?php echo PYS_URL; ?>/dist/images/pinterest-logo.svg" alt="pinterest-logo">
                <h4 class="secondary_heading">Add the Pinterest tag with our <br><a
                            href="https://www.pixelyoursite.com/pinterest-tag?utm_source=pixelyoursite-pro-plugin&utm_medium=plugin&utm_campaign=pro-plugin-pinterest"
