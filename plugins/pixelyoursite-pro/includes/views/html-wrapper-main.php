...
<div class="wrap" id="pys">
	...
	switch ( getCurrentAdminTab() ) {
		...
		case 'events':
			$title = 'PixelYourSite Pro Events';
			break;
            ...
            <div class="general-row d-flex">
                ...
                <div class="sidebar-col">
                    <div class="item-wrap">
                        <nav class="nav nav-pills flex-column">
                            ...
                            <div class="sidebar-menu-item">
                                ...
                                <img src="<?php echo PYS_URL . '/dist/images/help-icon.svg'; ?>"
                                     alt="help">
					...
					<?php if ( !isProductCatalogFeedProActive() ) : ?>
                        <div class="item-wrap">
                            <div class="icon">
                                <img src="<?php echo PYS_URL . '/dist/images/info.svg'; ?>" alt="info">
                            </div>
	...
	<?php include_once PYS_VIEW_PATH . '/UI/button-save.php'; ?>
