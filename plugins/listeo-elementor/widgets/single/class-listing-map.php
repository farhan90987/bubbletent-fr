...
class ListingMap extends Widget_Base
{
    ...
    {
        return __('Listing Map', 'listeo_elementor');
    }
    ...
    protected function render()
    {
        ...
        $template_loader->set_template_data($data)->get_template_part('single-partials/single-listing', 'location');  ?>
<?php
    }
}
