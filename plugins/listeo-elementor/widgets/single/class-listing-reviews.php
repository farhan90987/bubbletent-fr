 ...
 * @since 1.0.0
 */
class ListingReviews extends Widget_Base
{
    ...
    {
        return __('Listing Reviews', 'listeo_elementor');
    }
    ...
    { ?>
        <h3><?php esc_html_e('Reviews will be displayed here', 'listeo_elementor') ?></h3>
<?php
    }
}
