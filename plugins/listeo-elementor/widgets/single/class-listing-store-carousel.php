 ...
 * @since 1.0.0
 */
class ListingStoreCarousel extends Widget_Base
{
    ...
    {
        return 'listeo-listing-store-carousel';
    }
    ...
    {
        return __('Listing Store Carousel', 'listeo_elementor');
    }
    ...
    protected function render()
    {
        ...
        global $post;
        if (class_exists('WeDevs_Dokan') &&  get_post_meta(get_the_ID(), '_store_section_status', 1)) :   
