 ...
 * @since 1.0.0
 */
class ListingCalendar extends Widget_Base
{
    ...
    {
        return 'listeo-listing-calendar';
    }
    ...
    {
        return __('Listing Calendar View', 'listeo_elementor');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'show_title',
            [
                'label' => __('Show with title', 'listeo_elementor'),
    ...
    protected function render()
    {
        ...
        $data['show_title'] = $settings['show_title'];
        if (in_array($listing_type, array('rental', 'service'))) {
            if (get_option('listeo_show_calendar_single')) {
                $template_loader = new \Listeo_Core_Template_Loader;
                $template_loader->set_template_data($data)->get_template_part('single-partials/single-listing', 'calendar');
            }
        }
    }
    ...
    {
?>
        <h3>Calendar will be displayed here</h3>
<?php
    }
}
