...
class I18n {
	...
	public static function jsTranslate() {
		return array(
			...
			'BackInStockNotifier'                          => __( 'Back In Stock Notifier', 'yaymail' ),
			...
			'DiscountTitle'                                => __( 'Discount Title', 'yaymail' ),
			'PaymentMethodTitle'                           => __( 'Payment Method Title', 'yaymail' ),
			...
			'TrackingInformation'                          => __( 'Tracking information', 'yaymail' ),
