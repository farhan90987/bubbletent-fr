...
class RegisterMenu {
    ...
    public function get_submenus() {
        ...
        $licensing_plugins     = \YayMail\License\LicenseHandler::get_licensing_plugins();
        $yay_licensing_plugins = apply_filters( 'yaycommerce_licensing_plugins', [] );

        if ( ! empty( $licensing_plugins ) || ! empty( $licensing_plugins_yay_pricing ) || ! empty( $licensing_plugins_yay_currency ) || ! empty( $licensing_plugins_yay_swatches ) || ! empty( $licensing_plugins_yay_extra ) || ! empty( $licensing_plugins_yay_smtp ) || ! empty( $yay_licensing_plugins ) ) {
