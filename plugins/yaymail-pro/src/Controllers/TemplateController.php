...
class TemplateController extends BaseController {
    ...
    public function reset_templates( \WP_REST_Request $request ) {
        ...
        foreach ( $list_id as $id ) {
            ...
            $template_data['background_color']         = ! empty( $update_data['background_color'] ) ? $update_data['background_color'] : YAYMAIL_COLOR_BACKGROUND_DEFAULT;
            $template_data['text_link_color']          = ! empty( $update_data['text_link_color'] ) ? $update_data['text_link_color'] : YAYMAIL_COLOR_WC_DEFAULT;
            $template_data['content_background_color'] = ! empty( $update_data['content_background_color'] ) ? $update_data['content_background_color'] : '#ffffff';
