...
class Ajax {
    ...
    public function send_test_mail() {
        ...
        try {
            ...
            $attachments = EmailsLoader::get_attachments( $template, $language, true );
            $send_mail   = $class_wc_email->send( $email, $subject, $html, $headers, $attachments );
    ...
    public function processing_import_update_data( $data, $is_legacy = false ) {
        ...
        $template = new YayMailTemplate( $template_name, $language );
