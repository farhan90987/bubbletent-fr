	...
	class MCWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				MCAccount::addAccount($this->settings, '60fdd941de7df46be479d04244b67920', 'afcb7eacd60c32cf0d10f5b547165fba');
		MCAccount::updateApiPublicKey($this->settings, '60fdd941de7df46be479d04244b67920');
			}
