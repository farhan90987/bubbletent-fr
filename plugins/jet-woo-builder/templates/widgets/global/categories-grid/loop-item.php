...
<div class="jet-woo-categories__item <?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	<div class="<?php echo esc_attr( implode( ' ', $box_classes ) ); ?>" <?php echo esc_attr( $clickable_data ); ?> >
		<?php include $this->get_category_preset_template(); ?>
	</div>

	<?php if ( $clickable_item ) : ?>
		<a href="<?php echo esc_attr( $permalink ); ?>" class="jet-woo-item-overlay-link" <?php echo esc_attr( $target_attr ); ?> ></a>
	<?php endif; ?>
</div>