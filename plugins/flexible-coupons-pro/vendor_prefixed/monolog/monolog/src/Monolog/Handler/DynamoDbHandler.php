...
use FlexibleCouponsProVendor\Aws\Sdk;
use FlexibleCouponsProVendor\Aws\DynamoDb\DynamoDbClient;
use FlexibleCouponsProVendor\Monolog\Formatter\FormatterInterface;
use FlexibleCouponsProVendor\Aws\DynamoDb\Marshaler;
use FlexibleCouponsProVendor\Monolog\Formatter\ScalarFormatter;
...
class DynamoDbHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(DynamoDbClient $client, string $table, $level = Logger::DEBUG, bool $bubble = \true)
    {
        ...
        if (defined('FlexibleCouponsProVendor\Aws\Sdk::VERSION') && version_compare(Sdk::VERSION, '3.0', '>=')) {
            $this->version = 3;
