...
use FlexibleCouponsProVendor\Monolog\Formatter\ElasticaFormatter;
use FlexibleCouponsProVendor\Monolog\Logger;
use FlexibleCouponsProVendor\Elastica\Client;
use FlexibleCouponsProVendor\Elastica\Exception\ExceptionInterface;
/**
