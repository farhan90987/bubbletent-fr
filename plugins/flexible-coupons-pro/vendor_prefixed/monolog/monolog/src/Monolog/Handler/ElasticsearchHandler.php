...
use FlexibleCouponsProVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use FlexibleCouponsProVendor\Monolog\Logger;
use FlexibleCouponsProVendor\Monolog\Formatter\FormatterInterface;
use FlexibleCouponsProVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use FlexibleCouponsProVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use FlexibleCouponsProVendor\Elasticsearch\Client;
use FlexibleCouponsProVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use FlexibleCouponsProVendor\Elastic\Elasticsearch\Client as Client8;
/**
