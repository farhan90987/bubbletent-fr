...
use FlexibleCouponsProVendor\PhpConsole\Connector;
use FlexibleCouponsProVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use FlexibleCouponsProVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('FlexibleCouponsProVendor\PhpConsole\Connector')) {
