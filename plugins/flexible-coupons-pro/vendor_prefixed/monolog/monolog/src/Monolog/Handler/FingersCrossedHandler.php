...
use FlexibleCouponsProVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use FlexibleCouponsProVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
