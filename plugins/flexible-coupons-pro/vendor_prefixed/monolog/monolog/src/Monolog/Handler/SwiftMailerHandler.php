...
use FlexibleCouponsProVendor\Swift_Message;
use FlexibleCouponsProVendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\FlexibleCouponsProVendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
