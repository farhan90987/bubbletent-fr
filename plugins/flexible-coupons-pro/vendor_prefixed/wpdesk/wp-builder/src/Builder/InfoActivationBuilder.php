...
namespace FlexibleCouponsProVendor\WPDesk\PluginBuilder\Builder;
...
use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\FlexibleCouponsProVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
