...
namespace FlexibleCouponsProVendor\WPDesk\Plugin\Flow\Initialization;

use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Storage\StorageFactory;
/**
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\FlexibleCouponsProVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\FlexibleCouponsProVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
