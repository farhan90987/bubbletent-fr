...
namespace FlexibleCouponsProVendor\WPDesk\Plugin\Flow\Initialization\Simple;

use FlexibleCouponsProVendor\WPDesk\Helper\HelperRemover;
use FlexibleCouponsProVendor\WPDesk\Helper\PrefixedHelperAsLibrary;
use FlexibleCouponsProVendor\WPDesk\License\PluginRegistrator;
use FlexibleCouponsProVendor\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use FlexibleCouponsProVendor\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use FlexibleCouponsProVendor\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
use FlexibleCouponsProVendor\WPDesk\Plugin\Flow\Initialization\InitializationStrategy;
use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
/**
...
class SimplePaidStrategy implements InitializationStrategy
{
    ...
    /** @var SlimPlugin */
    private $plugin;
    public function __construct(\FlexibleCouponsProVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_before_init(\FlexibleCouponsProVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_init(\FlexibleCouponsProVendor\WPDesk_Plugin_Info $plugin_info)
    {
        if (!$this->plugin) {
            $this->plugin = $this->build_plugin($plugin_info);
        }
