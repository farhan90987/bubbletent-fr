...
namespace FlexibleCouponsProVendor\WPDesk\Plugin\Flow;

use FlexibleCouponsProVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
final class PluginBootstrap
{
     ...
     */
    private function init_translations(\FlexibleCouponsProVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \FlexibleCouponsProVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \FlexibleCouponsProVendor\WPDesk_Plugin_Info();
