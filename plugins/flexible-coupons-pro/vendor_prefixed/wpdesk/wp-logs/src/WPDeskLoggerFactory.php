...
use LogicException;
use FlexibleCouponsProVendor\Monolog\Handler\NullHandler;
use FlexibleCouponsProVendor\Monolog\Logger;
use FlexibleCouponsProVendor\Monolog\Registry;
use FlexibleCouponsProVendor\Monolog\Handler\StreamHandler;
use FlexibleCouponsProVendor\Psr\Log\LogLevel;
use FlexibleCouponsProVendor\WPDesk\Logger\WC\WooCommerceCapture;
use FlexibleCouponsProVendor\WPDesk\Logger\WP\WPCapture;
/**
