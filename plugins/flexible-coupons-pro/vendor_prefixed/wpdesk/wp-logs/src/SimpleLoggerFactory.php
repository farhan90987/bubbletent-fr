...
namespace FlexibleCouponsProVendor\WPDesk\Logger;

use FlexibleCouponsProVendor\Monolog\Handler\FingersCrossedHandler;
use FlexibleCouponsProVendor\Monolog\Handler\HandlerInterface;
use FlexibleCouponsProVendor\Monolog\Logger;
use FlexibleCouponsProVendor\Monolog\Handler\ErrorLogHandler;
use FlexibleCouponsProVendor\Monolog\Processor\PsrLogMessageProcessor;
use FlexibleCouponsProVendor\Monolog\Processor\UidProcessor;
use FlexibleCouponsProVendor\Psr\Log\LogLevel;
use FlexibleCouponsProVendor\WPDesk\Logger\WC\WooCommerceHandler;
