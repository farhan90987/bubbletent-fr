...
if (!\class_exists('FlexibleCouponsProVendor\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \FlexibleCouponsProVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-coupons-pro'), 'emergency' => \__('Emergency', 'flexible-coupons-pro'), 'alert' => \__('Alert', 'flexible-coupons-pro'), 'critical' => \__('Critical', 'flexible-coupons-pro'), 'error' => \__('Error', 'flexible-coupons-pro'), 'warning' => \__('Warning', 'flexible-coupons-pro'), 'notice' => \__('Notice', 'flexible-coupons-pro'), 'info' => \__('Info', 'flexible-coupons-pro'), 'debug' => \__('Debug', 'flexible-coupons-pro')];
        }
        /**
         * @param string $level
         * @param string $source
