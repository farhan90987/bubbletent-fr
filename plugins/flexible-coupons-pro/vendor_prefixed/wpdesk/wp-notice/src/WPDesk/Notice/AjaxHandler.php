...
namespace FlexibleCouponsProVendor\WPDesk\Notice;

use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use FlexibleCouponsProVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
