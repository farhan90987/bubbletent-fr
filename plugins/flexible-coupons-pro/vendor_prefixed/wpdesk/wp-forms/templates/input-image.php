...
?>">
			<?php 
\esc_html_e('Set image', 'flexible-coupons-pro');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'flexible-coupons-pro');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'flexible-coupons-pro');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'flexible-coupons-pro');
?>"
				},
				library: {
					type: ['image']
