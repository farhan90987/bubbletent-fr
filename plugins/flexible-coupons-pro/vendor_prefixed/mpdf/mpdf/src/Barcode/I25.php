 ...
 */
class I25 extends \FlexibleCouponsProVendor\Mpdf\Barcode\AbstractBarcode implements \FlexibleCouponsProVendor\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
    ...
    private function init($code, $printRatio, $checksum)
    {
        ...
        for ($i = 0; $i < $clen; $i = $i + 2) {
            ...
            if (!isset($chr[$charBar]) or !isset($chr[$charSpace])) {
                // invalid character
                throw new \FlexibleCouponsProVendor\Mpdf\Barcode\BarcodeException(sprintf('Invalid I25 barcode value "%s"', $code));
            }
