 ...
 */
class Code39 extends \FlexibleCouponsProVendor\Mpdf\Barcode\AbstractBarcode implements \FlexibleCouponsProVendor\Mpdf\Barcode\BarcodeInterface
{
    /**
     * @param string $code
    ...
    private function init($code, $printRatio, $extended, $checksum)
    {
        ...
        if ($code === \false) {
            throw new \FlexibleCouponsProVendor\Mpdf\Barcode\BarcodeException(sprintf('Invalid CODE39 barcode value "%s"', $code));
        }
        if ($checksum) {
            // checksum
