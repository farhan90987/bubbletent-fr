...
class RemoteContentFetcher implements \FlexibleCouponsProVendor\Psr\Log\LoggerAwareInterface
{
    /**
     * @var \Mpdf\Mpdf
     */
    ...
    public function getFileContentsByCurl($url)
    {
        ...
        if (curl_error($ch)) {
            ...
            if ($this->mpdf->debug) {
                throw new \FlexibleCouponsProVendor\Mpdf\MpdfException($message);
            }
        }
