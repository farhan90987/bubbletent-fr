 ...
 * response. However, the logic is identical so we can extend @see SA_Buy_Now_WC_PayPal_Reference_Transaction_API_Response_Payment
...
/**
 * Class to override response parameter prefix when processing DoReferenceTransaction request's response since in DoReferenceTransaction request Paypal does not send 'PAYMENTINFO_0_' prefix in response parameters.
 */
class SA_Buy_Now_WC_PayPal_Do_Reference_Transaction_API_Response_Payment extends SA_Buy_Now_WC_PayPal_Reference_Transaction_API_Response_Payment {
