 ...
 *  author    SkyVerge
 * Copyright (c) 2013-2015, SkyVerge, Inc.
 ...
 * @version 2.2.0
 */
abstract class SA_Buy_Now_WC_SV_API_Base {

	/**
	 * Variable to hold request method
	 *
	 ...
	 * Request user-agent
	 *
	 * @var string $request_user_agent
	 */
	protected $request_user_agent;

	/**
	 * Request HTTP version, defaults to 1.0
	 *
	 * @var string $request_http_version
	 */
	 ...
	 * Raw response body
	 *
	 * @var string $raw_response_body
	 */
	protected $raw_response_body;

	/**
	 * Response handler class name
	 *
	 * @var string $response_handler
	 */
	 ...
	 * @throws Exception Throws any exception occured.
	 ...
	 *
	 * @since 2.2.0
	 * @param string $raw_response_body unformatted response body.
	...
	protected function get_request_uri() {
		 ...
		 * @param \SA_Buy_Now_WC_SV_API_Base class instance.
		 */
	...
	protected function set_http_basic_auth( $username = '', $password = '' ) {
		...
		$this->request_headers['Authorization'] = sprintf( 'Basic %s', base64_encode( "{$username}:{$password}" ) ); // phpcs:ignore
	}
	 ...
	 *
	 * @since 2.2.0
	 * @param string $content_type content type for request header.
	 */
