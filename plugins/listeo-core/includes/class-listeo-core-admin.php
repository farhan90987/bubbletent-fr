    ...
    private function settings_fields()
    {
            ...
            'fields'                => array(
                ...
                array(
                    ...
                    'options'   => array(
                        ...
                        'near' => esc_html__('Near By', 'listeo_core'),
        ...
        $settings['stripe_connect'] = array(
            ...
            'fields'                => array(
                ...
                //     'id'        => 'stripe_environment', //each field id must be unique
                //     'type'      => 'select',
                //     'options'   => array(
                ...
                array(
                    ...
                    'type'      => 'text',
                    'description'      => __('Stripe Connect Test mode Client ID, get it from https://dashboard.stripe.com/test/settings/connect', 'listeo_core'),
                ),
                // array(
