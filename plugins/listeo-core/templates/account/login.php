		...
		<div class="my-account style-1 margin-top-5 margin-bottom-40">
				...
				<?php if ( isset( $_REQUEST['registered'] ) ) : ?>
				    ...
				    <p>
				        <?php
				            printf(
				                __( 'You have successfully registered to %s. We have emailed your password to the email address you entered.', 'listeo_core' ),
				                get_bloginfo( 'name' )
				            );
				        ?>
				    </p></div>
			...
			<div class="tab-content" id="tab1" style="display: none;">
				...
				<?php
//				require_once(LISTEO_PLUGIN_DIR.'includes/lib/recaptchalib.php');
