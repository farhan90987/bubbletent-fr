...
namespace FCSVendor\Psr\Log\Test;

use FCSVendor\Psr\Log\LoggerInterface;
use FCSVendor\Psr\Log\LogLevel;
use FCSVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FCSVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FCSVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FCSVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
