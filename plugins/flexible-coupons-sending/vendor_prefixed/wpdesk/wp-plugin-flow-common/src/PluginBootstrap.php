...
namespace FCSVendor\WPDesk\Plugin\Flow;

use FCSVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
{
    const LIBRARY_TEXT_DOMAIN = 'flexible-coupons-sending';
     ...
     */
    private function init_translations(\FCSVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \FCSVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \FCSVendor\WPDesk_Plugin_Info();
