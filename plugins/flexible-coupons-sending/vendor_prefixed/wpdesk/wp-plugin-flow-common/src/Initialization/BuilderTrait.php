...
namespace FCSVendor\WPDesk\Plugin\Flow\Initialization;

use FCSVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use FCSVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
use FCSVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
use FCSVendor\WPDesk\PluginBuilder\Storage\StorageFactory;
/**
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\FCSVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\FCSVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
