...
namespace FCSVendor\WPDesk\Plugin\Flow\Initialization\Simple;

use FCSVendor\WPDesk\Helper\HelperRemover;
use FCSVendor\WPDesk\Helper\PrefixedHelperAsLibrary;
use FCSVendor\WPDesk\License\PluginRegistrator;
use FCSVendor\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use FCSVendor\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use FCSVendor\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
use FCSVendor\WPDesk\Plugin\Flow\Initialization\InitializationStrategy;
use FCSVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use FCSVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
/**
...
class SimplePaidStrategy implements InitializationStrategy
{
    ...
    /** @var SlimPlugin */
    private $plugin;
    public function __construct(\FCSVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_before_init(\FCSVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_init(\FCSVendor\WPDesk_Plugin_Info $plugin_info)
    {
        if (!$this->plugin) {
            $this->plugin = $this->build_plugin($plugin_info);
        }
