...
use FCSVendor\Monolog\Handler\FingersCrossedHandler;
use FCSVendor\Monolog\Handler\HandlerInterface;
use FCSVendor\Monolog\Logger;
use FCSVendor\Monolog\Handler\ErrorLogHandler;
use FCSVendor\Monolog\Processor\PsrLogMessageProcessor;
use FCSVendor\Monolog\Processor\UidProcessor;
use FCSVendor\Psr\Log\LogLevel;
use FCSVendor\WPDesk\Logger\WC\WooCommerceHandler;
