...
if (!\class_exists('FCSVendor\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \FCSVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'flexible-coupons-sending'), 'emergency' => \__('Emergency', 'flexible-coupons-sending'), 'alert' => \__('Alert', 'flexible-coupons-sending'), 'critical' => \__('Critical', 'flexible-coupons-sending'), 'error' => \__('Error', 'flexible-coupons-sending'), 'warning' => \__('Warning', 'flexible-coupons-sending'), 'notice' => \__('Notice', 'flexible-coupons-sending'), 'info' => \__('Info', 'flexible-coupons-sending'), 'debug' => \__('Debug', 'flexible-coupons-sending')];
        }
        /**
         * @param string $level
         * @param string $source
