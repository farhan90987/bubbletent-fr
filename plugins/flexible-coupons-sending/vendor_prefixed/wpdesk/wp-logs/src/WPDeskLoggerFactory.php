...
use LogicException;
use FCSVendor\Monolog\Handler\NullHandler;
use FCSVendor\Monolog\Logger;
use FCSVendor\Monolog\Registry;
use FCSVendor\Monolog\Handler\StreamHandler;
use FCSVendor\Psr\Log\LogLevel;
use FCSVendor\WPDesk\Logger\WC\WooCommerceCapture;
use FCSVendor\WPDesk\Logger\WP\WPCapture;
/**
...
class WPDeskLoggerFactory extends BasicLoggerFactory
{
    ...
    {
        if (!defined('FCSVendor\WC_LOG_THRESHOLD')) {
            define('FCSVendor\WC_LOG_THRESHOLD', self::LEVEL_WC);
        }
