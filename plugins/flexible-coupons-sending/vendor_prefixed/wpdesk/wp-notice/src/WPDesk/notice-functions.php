...
if (!\function_exists('FCSVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \FCSVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('FCSVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('FCSVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \FCSVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('FCSVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('FCSVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \FCSVendor\WPDesk\Notice\Factory::notice($noticeContent, \FCSVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('FCSVendor\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('FCSVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \FCSVendor\WPDesk\Notice\Factory::notice($noticeContent, \FCSVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('FCSVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('FCSVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \FCSVendor\WPDesk\Notice\Factory::notice($noticeContent, \FCSVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('FCSVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('FCSVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \FCSVendor\WPDesk\Notice\Factory::notice($noticeContent, \FCSVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('FCSVendor\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('FCSVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \FCSVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('FCSVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
