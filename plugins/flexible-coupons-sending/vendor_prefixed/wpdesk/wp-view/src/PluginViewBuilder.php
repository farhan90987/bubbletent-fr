...
namespace FCSVendor\WPDesk\View;

use FCSVendor\WPDesk\View\Renderer\SimplePhpRenderer;
use FCSVendor\WPDesk\View\Resolver\ChainResolver;
use FCSVendor\WPDesk\View\Resolver\DirResolver;
use FCSVendor\WPDesk\View\Resolver\WPThemeResolver;
/**
