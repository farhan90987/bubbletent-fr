...
use FCSVendor\Monolog\Formatter\LineFormatter;
use FCSVendor\Monolog\Formatter\FormatterInterface;
use FCSVendor\Monolog\Logger;
use FCSVendor\Monolog\Utils;
use FCSVendor\PhpConsole\Connector;
use FCSVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use FCSVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('FCSVendor\PhpConsole\Connector')) {
