...
use FCSVendor\Elastica\Document;
use FCSVendor\Monolog\Formatter\FormatterInterface;
use FCSVendor\Monolog\Formatter\ElasticaFormatter;
use FCSVendor\Monolog\Logger;
use FCSVendor\Elastica\Client;
use FCSVendor\Elastica\Exception\ExceptionInterface;
/**
