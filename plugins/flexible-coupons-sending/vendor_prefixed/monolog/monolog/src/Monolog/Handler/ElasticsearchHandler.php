...
use FCSVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use FCSVendor\Monolog\Logger;
use FCSVendor\Monolog\Formatter\FormatterInterface;
use FCSVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use FCSVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use FCSVendor\Elasticsearch\Client;
use FCSVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use FCSVendor\Elastic\Elasticsearch\Client as Client8;
/**
