...
use FCSVendor\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use FCSVendor\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use FCSVendor\Monolog\Logger;
use FCSVendor\Monolog\ResettableInterface;
